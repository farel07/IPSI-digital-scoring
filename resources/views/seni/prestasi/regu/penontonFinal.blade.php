        ...
        <div class="bg-white rounded-xl shadow-md p-4 mb-4">
            <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-blue-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-blue-600 font-bold text-xs">BG</span>
                            </div>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-blue-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-blue-600 font-bold text-xs">AP</span>
                            </div>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-blue-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-blue-600 font-bold text-xs">RH</span>
                            </div>
                            <h4 class="font-bold text-gray-800 text-xs text-center">RIZKI HIDAYAT</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-l-4 border-red-400 pl-4">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-red-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-red-600 font-bold text-xs">SA</span>
                            </div>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-red-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-red-600 font-bold text-xs">TW</span>
                            </div>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 bg-red-200 rounded-full flex items-center justify-center mb-1">
                                <span class="text-red-600 font-bold text-xs">LK</span>
                            </div>
                            <h4 class="font-bold text-gray-800 text-xs text-center">LIM KENG HUAT</h4>
                        </div>
                    </div>
                </div>
            </div>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'97b3dcd7b773ce19',t:'MTc1NzIyMzUzNS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
