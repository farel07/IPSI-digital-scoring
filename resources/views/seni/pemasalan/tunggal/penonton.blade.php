    ...
    <header class="bg-white border-b border-gray-200 px-6 py-4">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="bg-blue-600 text-white px-3 py-1 rounded font-bold text-sm">
                    A - 2
                </div>
            </div>
    ...
    <main class="max-w-7xl mx-auto px-6 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center space-x-6">
                    ...
                    <!-- Foto Atlet -->
                    <div class="flex-shrink-0">
                        <div class="w-20 h-20 bg-gray-200 rounded-full border-2 border-gray-500 flex items-center justify-center overflow-hidden">
                    ...
                    <!-- Info Atlet -->
                    <div class="flex-1">
                        <h2 class="text-2xl font-bold text-black mb-1">INDONESIA</h2>
                        <p class="text-dark-600 font-medium cursor-pointer hover:text-dark-800">
                            BENNY G. SUMARSONO
                        </p>
                    </div>
                </div>
        ...
        <div class="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-10 gap-1">
                <div class="bg-green-600 text-white text-center py-3 rounded-md font-bold text-lg cursor-pointer hover:bg-green-700 transition-colors" onclick="editScore(this)">9.90</div>
                <div class="bg-green-600 text-white text-center py-3 rounded-md font-bold text-lg cursor-pointer hover:bg-green-700 transition-colors" onclick="editScore(this)">9.90</div>
                <div class="bg-green-600 text-white text-center py-3 rounded-md font-bold text-lg cursor-pointer hover:bg-green-700 transition-colors" onclick="editScore(this)">9.90</div>
                <div class="bg-green-600 text-white text-center py-3 rounded-md font-bold text-lg cursor-pointer hover:bg-green-700 transition-colors" onclick="editScore(this)">9.90</div>
                <div class="bg-green-600 text-white text-center py-3 rounded-md font-bold text-lg cursor-pointer hover:bg-green-700 transition-colors" onclick="editScore(this)">9.90</div>
