    ...
    <div class="max-w-6xl mx-auto bg-white shadow-lg">
        ...
        <div class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex justify-between items-start">
                <div>
                    <div class="text-black-600 text-xs font-semibold uppercase tracking-wide">PELATIH</div>
                    <div class="text-black-700 font-semibold text-sm mt-1">RISKA HERMAWAN, RIRIN RINASIH</div>
                </div>
